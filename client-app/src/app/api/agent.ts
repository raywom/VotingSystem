...
const Activities = {
    list: (params: URLSearchParams) => axios.get<PaginatedResult<Activity[]>>('/polls', { params })
        .then(responseBody),
    details: (id: string) => requests.get<Activity>(`/polls/${id}`),
...
const Profiles = {
    ...
    listActivities: (username: string, predicate: string) =>
        requests.get<UserActivity[]>(`/profiles/${username}/polls?predicate=${predicate}`)
}
